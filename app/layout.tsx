...
export const metadata: Metadata = {
  ...
  // FB-141: the pocket studio, installable. iOS reads `apple-touch-icon` and ignores the manifest's
  // icons; Android reads the manifest. Both are generated by scripts/make-icons.mjs.
  manifest: '/manifest.webmanifest',
  appleWebApp: { capable: true, title: 'Foundry', statusBarStyle: 'default' },
...
export const viewport: Viewport = {
  width: 'device-width',
  initialScale: 1,
  // FB-141: the installed studio's status bar matches the rail behind it rather than defaulting to
  // white, which on a phone reads as a browser chrome the app forgot to remove.
